...
// Test fixture literals shared across aggregate test cases (goconst).
// checkedAt1 is defined in application_test.go (same package).
const clusterProdEU = "Production EU"
...
func TestFlatten_Fixtures(t *testing.T) {
	...
	want := []Row{
		{
			EntityType: entityTypeCluster, EntityID: "c1", EntityName: clusterProdEU, Cluster: clusterProdEU,
			Product: "kubernetes", Cycle: "1.28", Status: "eol",
			EOLDate: "2024-10-28", Latest: "1.28.15", LatestAvailable: "1.32.3",
			CheckedAt: checkedAt1,
		},
		{
			EntityType: entityTypeNode, EntityID: "n1", EntityName: "worker-01", Cluster: clusterProdEU,
			Product: "containerd", Cycle: "1.7", Status: "approaching_eol",
			EOLDate: "2026-08-15", CheckedAt: checkedAt1,
		},
		{
			EntityType: entityTypeNode, EntityID: "n1", EntityName: "worker-01", Cluster: clusterProdEU,
			Product: "ubuntu", Cycle: "22.04", Status: "supported",
			Latest: "22.04.4", CheckedAt: checkedAt1,
		},
		{
